 ...
 *   Test 9 (version bump): header /^Version: 1\.28$/m AND footer
 *           /_Mindrian Canon v1\.28 - MindrianOS Plugin_/. (Canon moved forward each wave,
 *           now at 1.28 at Phase 348's entry 41 supersession narrowing; entry 31's
 *           invariants are unchanged, only the version anchor tracks
 *           the current canon.)
...
// ---------------------------------------------------------------------------
// Test 9: the header + footer version (canon at 1.28 after Phase 348's entry 41 supersession narrowing; anchor tracks the version forward, entry-31 invariants unchanged).
// ---------------------------------------------------------------------------
