 ...
 *   Test 7 (version bump): header `/^Version: 1\.25$/m` AND footer
 *           `/_Mindrian Canon v1\.25 - MindrianOS Plugin_/`.
 *   Test 8 (map row, light): `docs/CANON-PHASE-MAP.md` carries a "v1.25" token, an
...
// ---------------------------------------------------------------------------
// Test 7: the header + footer version bump to 1.25.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Test 8: the CANON-PHASE-MAP carries a v1.25 token + an entry-38 ref + the
// phase slug.
// ---------------------------------------------------------------------------
