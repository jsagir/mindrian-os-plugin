...
// ---------- 9. Canon ratified with the Appendix D ledger entry (version anchor tracks forward: 1.28 after Phase 348's entry 41 supersession narrowing, previously the Phase 340 Wave C corpus-figures amendment, entry 40; was 1.24 after the Phase 210 entry-37 R16 advisory amendment, 1.22 post-Phase-195 FCM-08, 1.23 post-Phase-190) ----------
ok(/Version:\s*1\.28/.test(canon), 'CANON: header not at current v1.28');
...
console.log(`PASS test-205-elevation-doctrine-floor.cjs (${checks} assertions: canon<->skill<->body elevation-doctrine consistency, 3 directions in all 3 surfaces, persona-ratio, hedged-always, four-check, clarify-vs-reframe, artifact!=conversation, single-source body-pointer, v1.28 + entry 34, zero em-dashes)`);
