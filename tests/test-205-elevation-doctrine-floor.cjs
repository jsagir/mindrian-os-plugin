...
// ---------- 9. Canon ratified at v1.21 with the Appendix D ledger entry ----------
ok(/Version:\s*1\.21/.test(canon), 'CANON: header not at ratified v1.21');
...
console.log(`PASS test-205-elevation-doctrine-floor.cjs (${checks} assertions: canon<->skill<->body elevation-doctrine consistency, 3 directions in all 3 surfaces, persona-ratio, hedged-always, four-check, clarify-vs-reframe, artifact!=conversation, single-source body-pointer, v1.21 + entry 34, zero em-dashes)`);
