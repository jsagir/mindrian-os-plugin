 ...
 *   Test 8 (version bump): header /^Version: 1\.23$/m AND footer
 *           /_Mindrian Canon v1\.23 - MindrianOS Plugin_/.
 *   Test 9 (map row, light): docs/CANON-PHASE-MAP.md carries a "v1.23" token AND an
...
// ---------------------------------------------------------------------------
// Test 8: the header + footer version bump to 1.23.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Test 9: the CANON-PHASE-MAP carries a v1.23 token + an entry-36 / R16 ref + shipped.
// ---------------------------------------------------------------------------
ok('CANON-PHASE-MAP carries a "v1.23" token', /v1\.23/.test(map));
