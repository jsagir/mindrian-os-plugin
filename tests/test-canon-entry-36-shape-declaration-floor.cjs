 ...
 *   Test 8 (version bump): header /^Version: 1\.28$/m AND footer
 *           /_Mindrian Canon v1\.28 - MindrianOS Plugin_/ (anchor moved forward each wave,
 *           now at 1.28 by Phase 348's entry 41 supersession narrowing).
 *   Test 9 (map row, light): docs/CANON-PHASE-MAP.md carries a "v1.28" token AND an
...
// ---------------------------------------------------------------------------
// Test 8: the header + footer version bump to 1.28 (anchor moved by Phase 340 Wave C entry 40 and Phase 348 entry 41).
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Test 9: the CANON-PHASE-MAP carries a v1.28 token + an entry-36 / R16 ref + shipped.
// ---------------------------------------------------------------------------
