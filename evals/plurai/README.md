...
| `10-synthetic-expert-construction.csv` | Output Quality / Construction Fidelity | Phase 203 Directive 1 + Directive 2 (surface A); Canon Part 7, Part 8 | "Given a synthetic-expert GENESIS descriptor (hat, domain, subdomain, beautiful_question, research_approach, lens_count, distinct_source_count), classify it faithful (a valid de Bono hat, a coherent domain and subdomain, a GENUINE beautiful-question derived from the lens, a research-approach that cites the multi-lens fan-out, at least two lenses, and more than one distinct source) or hollow (any breach: an invalid hat, an empty domain or subdomain, a template-stub question, a generic method, too few lenses, one source wearing many hats, a Part-8 leak, or a banned dash). A hollow construction is a costume and fails independently of how it later answers. Judge model: fable. Local parity gate: lib/core/synthetic-expert-construction-gate.cjs. Baseline: evals/plurai/203-baseline.json (surface A)." |
