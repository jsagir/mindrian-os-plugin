...
```
node "${CLAUDE_PLUGIN_ROOT}/scripts/vault-regenerate-all.cjs" <roomDir>
```
...
- **Work:** run `node "${CLAUDE_PLUGIN_ROOT}/scripts/vault-section-minto-generator.cjs" <roomDir> --plan --section <name>`,
...
```
node "${CLAUDE_PLUGIN_ROOT}/scripts/vault-section-minto-generator.cjs" <roomDir> --plan --section <section-name>
```
...
```
node "${CLAUDE_PLUGIN_ROOT}/scripts/vault-section-minto-generator.cjs" <roomDir> --write --section <section-name> --narrative <tempfile-path>
```
