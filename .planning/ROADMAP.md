...
Plans:
- [ ] 169-00-PLAN.md -- WAVE 1 FOUNDATION (canon amendment, BLOCKING checkpoint): mint the room-lineage edge NESTED_WITHIN into the frozen ALLOWED_EDGE_TYPES set (the D-169-11 graph-navigable joint; PART_OF illegal for a room target, BELONGS_TO absent from the frozen set) + canon Part 4 + Appendix D entry 23 + v1.11 -> v1.12 + the room-lineage floor test, one atomic navigator-gated lockstep
