...
**Requirements**: TBD (discuss step locks: dependency-delivery design, `.planning` runtime readers such as `lib/core/pitch-feedback-schemas.cjs:286`, Windows tarball path-length behavior, whether `.claude-plugin/plugin.json` must sit at tarball root)
**Depends on:** Phase 340
**Plans:** 0 plans

Plans:

- [ ] TBD (run /gsd-plan-phase 341 to break down)
