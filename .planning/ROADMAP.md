...
- [ ] 169-02-PLAN.md -- WAVE 3 FOUNDATION (GDH-01): lib/core/room-root.cjs the ONE `.room-root` resolver + repoint the hook + 3 scripts (root cause #1)
- [ ] 169-03-PLAN.md -- WAVE 3 FOUNDATION (GDH-04): lib/core/doc-text-extractor.cjs pure-JS non-destructive .docx/.html extractor (root cause #3)
