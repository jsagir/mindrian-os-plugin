...
**Status:** IN PROGRESS 2026-06-23 (2/3 plans complete: 175-01 shipped the born-wired /mos:deck command + deck-styles.json; 175-02 shipped the WARN-first deck-design ruleset --check). Next: 175-03 (aliases + make-land repoint + registry-proof + regression). Via `/gsd-execute-phase 175`.
