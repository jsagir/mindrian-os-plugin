...
- [ ] 150.10-01-PLAN.md -- CHECKPOINT (brain_write-gated, autonomous:false): additive Session 2 Brain ingestion -- dedup-first merge + new-node wired-on-creation + example ILLUSTRATES edges + IRIS 2026 Session 2 Lecture anchor + M1-M5 PREREQUISITE/FEEDS_INTO flow seed + orphan-scan zero gate + Part 8 zero-egress [ST-01..ST-05] [wave 1]
