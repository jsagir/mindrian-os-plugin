...
### Phase 177 - The Behavioral Channel (larry-behavioral-channel) - SCAFFOLDED 2026-06-24
...
Plans:
- [ ] 177-01-PLAN.md -- Wave 1: BCH-S1 canonical investment_level + turn_count term, BCH-05/06 floor/ceiling/band consts (BEHAVIORAL_CHANNEL_CEILING == 0.85), BCH-PERSONA/17 ignite-persona dial seed (3 tasks)
- [ ] 177-02-PLAN.md -- Wave 1: BCH-REG/16 greenfield 4-arrow HUD (lib/hmi/dial-selector.cjs) + synchronous pre-compose CONTROL path, BCH-10 arrows mutate investment_level/posture (2 tasks)
- [ ] 177-03-PLAN.md -- Wave 1: BCH-18 re-scoped single-axis role_blend producer threaded to birthRoom opts.roleBlend (2 tasks)
- [ ] 177-04-PLAN.md -- Wave 2 (depends 177-01): BCH-S5 turn-stage reach-eligibility + BCH-S4a saturation by turn-count/node-delta, inside dispatchSensors (2 tasks)

**Status:** WAVE 1 PLANNED 2026-06-24. CONTEXT + SPEC (BCH-01..18) + RESEARCH (114 claims verified vs live beta.7) committed; tests/run-all-177.sh + 12 BCH suite stubs (RED by design); BCH-14 Part 8 zero-egress fence GREEN. Wave 1 = 4 PLAN.md files (177-01..04, 9 tasks total) turning test-bch-10/16/17/18 + the new BCH-S5/S4a suites green; thresholds live in f-selector-ranker.cjs (never a prompt); no reach/posture minted, no Brain wire. Next: /gsd-execute-phase 177.
