...
- [ ] 169-07-PLAN.md -- WAVE 4 SURFACE, THE CONSTITUTIONAL CORE (GDH-08/09 + D-169-11): lib/core/graph-self-heal.cjs (detectUnsentineledArtifactFolder + healRoom: birthRoom reuse + operational joint [registry parent + sentinel parent] + the NESTED_WITHIN graph joint + the FEYNMAN ## Timeline (auto) temporal, approvedBy-gated, arbitrary-depth) + the room-birth.cjs opts.parent amendment
