...
**Plans:** 5 plans (planned 2026-05-12), 5 waves -- one PLAN.md per build sub-phase. Per the maintainer: DEEP RESEARCH was done (`122-RESEARCH.md`), now `/gsd:review --phase 122`, then `/gsd:execute-phase 122`.

Plans:
- [ ] 122-01-PLAN.md -- Frontmatter contract + retrofit (algorithmic cohort first) + docs/COMMAND-FRONTMATTER.md + Wave-0 test scaffold (wave 1)
