...
**Plans:** 18 plans in 16 waves

Plans:

- [ ] 267-01-PLAN.md -- W0: baseline on the unchanged tree, SDK-independent wire helper, run-all-267 aggregator, sdk-era / lockstep / per-commit CIRS gate tests (MCPV2-01, -08, -19)
