...
- [ ] 169-04-PLAN.md -- WAVE 4 SURFACE (GDH-02/03/04/05 + D-169-11): the LLM candidate producer + the runChain derivation composer + the ROOT-FILES pass + TRANSITIVE sub-room recursion + the RECURSIVE rollupSubRooms (walks NESTED_WITHIN at arbitrary depth) + the disabled legacy cascade (root causes #2/#3/#4)
