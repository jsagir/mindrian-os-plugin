...
- [ ] **Phase 240.1: Context-Layer Drift Detection** - Per-room STATE.md regeneration carries a schema version stamp instead of blind-overwriting it, room.db's graph and BRAIN.md name the SEMANTIC-vs-CONTEXT boundary `INDEXER_OWNED_NODE_TYPES` already enforces, and a benchmark gate measures whether room context actually improves Larry's answer accuracy (7/7 plans landed 2026-07-30, gsd-verifier pending)
