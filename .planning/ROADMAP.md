...
- [ ] 156-01-PLAN.md (Wave 1) -- scaffold /mos:futures command + connector frontmatter (Part 7 chain-not-duplicate) + orchestrator shell with frontmatter validators + caps + advisory causal-cue flagger [FW-01, FW-03, FW-04]
