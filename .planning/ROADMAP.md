...
**Status:** IN PROGRESS 2026-06-23 (1/3 plans complete: 175-01 shipped the born-wired /mos:deck command + deck-styles.json). Next: 175-02 (deck-design ruleset --check, WARN-first) then 175-03 (aliases + make-land repoint + registry-proof + regression). Via `/gsd-execute-phase 175`.
