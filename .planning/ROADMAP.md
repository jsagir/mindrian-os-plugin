...
- [ ] 169-05-PLAN.md -- WAVE 5 SURFACE (GDH-02/06/07/08): the HEAL-FIRST `/mos:graph --derive` backfill (STEP 0 = detect + Decision-Gate-confirm + healRoom, then resolve/rebuild/derive) + the Stop sweep hook + the SessionStart drain + the idempotence guard
