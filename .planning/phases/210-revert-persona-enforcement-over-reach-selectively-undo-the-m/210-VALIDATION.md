...
| 210-05-04 | 05 | 2 | 210-E-2b (doctrine surfaces: larry-extended.md, ui-system SKILL.md) | T-210-17b | fire-if-genuine-fork doctrine on both auto-loaded surfaces; old unconditional phrasing absent; zero remaining `[BINDING:` anywhere outside CHANGELOG history | unit + doctrine-presence grep | `node tests/test-gate-native-fire-w1.cjs` (P3 re-pointed) + `node tests/test-209-incident-replay.cjs` | ✔ re-point | ⬜ pending |
