...
| R356-04 / D-14 | a labeled command's `flag` equals its label regardless of p (`flag_source: "label"`); an unlabeled or hash-changed command's `flag` = p >= T (`flag_source: "jev"`) | unit | same file | ❌ W0 | ⬜ pending |
