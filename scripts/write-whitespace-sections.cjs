...
function main() {
  ...
  for (const section of sectionDirs) {
    ...
    const content = buildWhitespaceMd(section, sectionGaps, sectionNovelty, timestamp, interpGapMap, topicForest);
 ...
 * @returns {string}
 */
function buildWhitespaceMd(section, sectionGaps, sectionNovelty, timestamp, interpGapMap, topicForest) {
