...
| **Brain** | Neo4j 27,904 nodes (incl. 12,401 MethodologyChunk substrate; ~15.4K teaching-graph core) + 19,987 relationships + Pinecone 12,485 vectors + teaching intelligence (live read 2026-06-27) | mindrian-brain.onrender.com (remote MCP) | Jonathan -- SECRET IP |
...
**1. The Teaching Graph (Neo4j -- 27,904 nodes incl. 12,401 MethodologyChunk substrate; ~15.4K teaching-graph core, 19,987 relationships; live read 2026-06-27)**
...
59 books + 59 tools + 12,485 Pinecone vectors (live read 2026-06-27). Not a list -- a semantic web.
...
- **Brain IP protection**: The 27,904-node teaching graph (live read 2026-06-27), grading intelligence, and mode engine calibration are proprietary -- never distributed, only served via MCP
...
| Neo4j Aura + Brain MCP | 27,904-node graph at mindrian-brain.onrender.com (remote MCP, Streamable HTTP); live read 2026-06-27 | Deployed |
| Pinecone | 12,485 vectors (pws-brain, 1024-dim) for Brain semantic search; live read 2026-06-27 | Deployed |
