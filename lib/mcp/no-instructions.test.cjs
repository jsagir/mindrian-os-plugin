...
// This repo's own budget: 48 bytes of headroom under HOST_INSTRUCTIONS_CAP_BYTES
// so a small future edit cannot silently cross the hard platform ceiling.
// Raised from 1950 to 2000 (260917-dia) to fit naming `mindrian-brain` as the
// server hosting brain_* at both mention points in RUNTIME_INSTRUCTIONS.
const SERVED_BUDGET_BYTES = 2000;
