...
function register(server, ctx) {
  server.registerTool('claim_verify', {
    title: 'Claim Verify',
    description: CLAIM_VERIFY_DESCRIPTION,
  ...
  server.registerTool('claim_read', {
    title: 'Claim Read',
    description: CLAIM_READ_DESCRIPTION,
    inputSchema: z.object({
...
// hostBlock is shared with lib/mcp/tools/question.cjs so there is one host detection path (358-09).
module.exports = { register, connectors, hostBlock };
