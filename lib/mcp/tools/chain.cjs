...
// approve verdict matched to this process's single-use resume ledger), joined
// to the posture data in data/connector-registry.json. That is a STRONGER and
// more specific control than a blanket write-path flag.
//
