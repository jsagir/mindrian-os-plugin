...
function render(args) {
  ...
  // 102-04..05 wire them up. They are already pulled out above so callers
  // can rely on the destructuring contract. (102-03 consumed: tier, jtbd,
  // roomDir via the Z4 dispatcher; 102-04/05 still own mode + provenance.)
  void mode; void provenance;
  ...
  // the compaction gate fired). Only this Phase 102-02 field is published;
  // siblings 102-03 / 102-04 / 102-05 will add their own keys when they land.
  return { rendered: composed, contract: { compact: compact } };
}
