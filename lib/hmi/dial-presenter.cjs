 ...
 *   - opts.withPreview  -> each of the (up to MAX_K=3) chooser rows gains a
 ...
 * scalars (MAX_K=3, DIAL_REACH_K=6, the 0.70/0.15 gate, the 5 render states,
 * the single-marker glyph rule) are UNTOUCHED -- this is a render-layer change,
 * never a resolve-layer one.
 *
 * License: BSL 1.1.
 *
 * ---------------------------------------------------------------------------
