 ...
 *   2. rendered.askuserquestion_binding -- the scalar BINDING imperative line.
 ...
 * Binding (E1, new): [BINDING: call the AskUserQuestion tool ... (SEED-021)]
 */
function appendAskUserQuestionTrailer(rendered, subShape) {
  ...
  // Surface 2: the E1 binding imperative -- makes the trigger self-decoding.
  // Phrased as a directive to Larry: fire the tool THIS response, do not draw
  // the block as text (no card, no picture -- SEED-021).
