...
/**
 * Phase 148-03 (IRW-04, D-03): resolve a reach_id / sub_mode / standing-option
 * key to its toggleable-component archetype. Reads lib/hmi/reach-component-map.json
 * (registry-is-the-table). Returns the default 'select' on any miss.
 */
function resolveArchetype(reachIdOrSubMode) {
  ...
  return (typeof hit === 'string' && hit.length > 0) ? hit : ARCHETYPE_DEFAULT;
}
