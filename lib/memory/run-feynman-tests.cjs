...
const TEST_FILES = [
  ...
  // Phase 127.1 brain-graphrag-collapse-pinecone-neo4j-hnsw (Wave 0 harness scaffold + Wave 1/2 outputs)
  //   Surface 1 -> Plan 127.1-01 produces embedding-manifest.fixture.json (1,427 byte-identical SHA256 pairs).
  //   Surface 2 -> Plan 127.1-02 produces index-config.fixture.json (SHOW INDEXES dim=1024 cosine ONLINE).
  //   Surface 3 -> Plan 127.1-03 produces overlap-baseline + overlap-neo4j fixtures (BLOCKING gate >= 0.80).
