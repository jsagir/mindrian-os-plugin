...
// --- Test 7: doctor.cjs --stale-first-touch surfaces class K ------------
{
  ...
  assert(
    // Phase 217 Plan 03: the hand-coded 'class K stale-first-touch' render
    // branch was deleted; the generic loop now prints the registry id
    // 'stale-first-touch-copy' (status/payload/sub-lines preserved).
    'Test 7b: output contains "stale-first-touch-copy" row',
    /stale-first-touch-copy/.test(out),
