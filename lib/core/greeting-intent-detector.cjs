 ...
 * require of lib/core/brain-client.cjs, bin/mindrian-brain-mcp-client.cjs,
 * node:http, node:https, or any use of fetch; any Brain-specific or
 * Theo-specific query shape; any filesystem read or write; any
 * process.env read. The classifier decides, and nothing else -- Theo's
 * cutover requires zero changes to this file.
 */
