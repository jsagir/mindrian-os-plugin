...
module.exports = {
  ...
  // deletion in this door, signature-bound to the machine-authored legacy
  // entity rows typed-entity.cjs itself minted (see its docblock). Same thin
  // additive-re-export pattern; no caller reaches the rows by raw SQL.
