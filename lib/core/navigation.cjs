...
module.exports = {
  ...
  // Insight queries (Plan 109-05 will replace these stubs).
  findContradictions: notImplementedYet('findContradictions', 'Plan 109-05'),
  findUnsupportedClaims: notImplementedYet('findUnsupportedClaims', 'Plan 109-05'),
  findBlockingAssumptions: notImplementedYet('findBlockingAssumptions', 'Plan 109-05'),
  findStaleDecisions: notImplementedYet('findStaleDecisions', 'Plan 109-05'),
  findOpenQuestions: notImplementedYet('findOpenQuestions', 'Plan 109-05'),

  // findRecentChanges (Plan 109-03 LIVE).
  findRecentChanges: memoryEvents.findRecentChanges,

  // Opportunity ranking (Plan 109-05 will replace).
  findRelevantOpportunities: notImplementedYet('findRelevantOpportunities', 'Plan 109-05'),
  ...
  // Room Home (Plan 109-09 will replace).
  getRoomHomeView: notImplementedYet('getRoomHomeView', 'Plan 109-09'),
