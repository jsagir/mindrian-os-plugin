...
//
//   semantic leg = local MiniLM cosine via the 211-01 embedding spine
//                  (embedTexts / encoderProvenance), reusing the SAME
//                  cosineSimilarity score() trusts (Part 7, no fork).
...
// for ground truth (the s11 "store as MiniLM-cosine-differential with model +
