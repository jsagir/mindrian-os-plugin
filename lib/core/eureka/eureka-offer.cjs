...
const { DIRECTIONS } = require('../direction-convention.cjs');
...
// recognises it as an enum member (not free prose). Sourced from
// direction-convention.cjs's DIRECTIONS, not a local copy of the two ids.
const DIRECTION_ENUM = DIRECTIONS;
