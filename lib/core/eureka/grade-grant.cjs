...
// The 8 standard MindrianOS room sections (mirrors room-birth.cjs SECTION_NAMES,
// the single source of truth for the canonical scaffold). A criterion's
// room_section must be one of these or null (a pure process/reporting item).
const ROOM_SECTION_VALUES = Object.freeze(new Set([
  'problem-definition',
  'market-analysis',
  'solution-design',
  'business-model',
