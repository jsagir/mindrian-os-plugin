...
// to tier-2b. This value is MEASUREMENT-CALIBRATED against the real local encoder
// in quick 260714-k44 Task 3 (the margin table is recorded in that task's SUMMARY);
// the constant is updated there if the measured WHAT-vs-WHY separation demands it.
