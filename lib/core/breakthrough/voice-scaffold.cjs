...
// Phase 188-01 (SFS-06): that renderer is retained as the verb-set home even though
// the Breakthrough SHAPE collapsed to an F.1 next-move (bare F.7 is the dial now).
