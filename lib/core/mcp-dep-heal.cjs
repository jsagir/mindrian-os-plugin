 ...
 * Phase 267 Plan 05 (canary): the fallback grew a third entry,
 ...
 * '@modelcontextprotocol/sdk' monolith. '@modelcontextprotocol/sdk' stays in
 * the fallback until 267-17 removes it as a dependency entirely (it is still
 * required by the local server and the two in-repo MCP clients until later
 * Phase 267 waves migrate them).
 *
