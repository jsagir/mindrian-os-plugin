...
//   retired mindrian-brain.onrender.com replica. Seeing exactly this count
//   means the wire is pointed at a copy, not canon -- a NAMED failure
//   (stale_replica_signature) rather than a generic count miss, checked
//   BEFORE the generic floor so the named reason always wins.
