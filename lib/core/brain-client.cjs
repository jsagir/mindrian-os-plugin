...
async function query(cypher) {
  return callTool('brain_query', { cypher: cypher });
}
...
module.exports = {
  ...
  getFrameworkChain,
  // SEC-01/SEC-02 test surface: not part of the public API. See
  // lib/memory/security-trifecta.test.cjs. Helpers are small and pure.
  _test: { sanitizeCypherInput, checkFilePermissions },
};
