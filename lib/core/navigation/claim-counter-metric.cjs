...
// WR-04 (343 review): the extended banned-adjective list this file's own
// docblock declares (lines 52-56), exported so a consuming test (or any
// future reader) has ONE home for the list rather than a second, driftable
// copy. This is the base 13-word list graph-integrity-counts.cjs shares,
// plus five words added specifically because this file's `divergence`
// boolean must never be rendered as a ratio/score/percent: 'low', 'high',
// 'ratio', 'score', 'percent'.
const BANNED_ADJECTIVES = Object.freeze([
  'orphan', 'orphaned', 'dangling', 'broken', 'corrupt', 'stale', 'unhealthy',
  'degraded', 'dense', 'sparse', 'density', 'risk', 'healthy',
  'low', 'high', 'ratio', 'score', 'percent',
]);
