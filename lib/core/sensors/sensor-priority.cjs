...
//   SENS-09      diffusion-adoption   (a derived diffusion/adoption or dominant-design read)
...
const SENS_PRIORITY = Object.freeze([
  ...
  Object.freeze({
    id: 'SENS-09',
    optimizes: 'the count of diffusion-adoption reaches routed to ACE or to Dominant Design',
    watched_by: 'the count of those routed reaches that convert to a filed dual-use, diffusion or dominant-design finding',
    why: 'a diffusion or dominant-design read that never produces a finding is routing traffic for nothing',
  }),
  Object.freeze({
    id: 'SENS-SHOW',
