...
//                                      and their family), and, per the 267.3-04
//                                      ruling, for a pure ROUTER with no
//                                      first-party reward of its own (show).
//                                      Distinct from the scripting opt-out,
//                                      which is legitimate only under an actual
//                                      --no-interactive / --script / -q
//                                      invocation.
//
// Amended a second time by Phase 267.3 plan 04 under the navigator ruling in
// `267.3-CLASSIFICATION.md` (`## Navigator ruling`, Row 13). One member added,
// no more, no fewer, no respellings:
//   live_deliverable                -- a real, deployed, shareable artifact
//                                      produced by an irreversible action (a
//                                      live URL, a sent file, a filed
//                                      document), where the navigator could not
//                                      have produced it themselves in the
//                                      available time, understands it instantly
//                                      on sight, would show it on someone
//                                      else's screen, and no general-purpose
//                                      assistant produces the equivalent
//                                      (commands/publish.md:149 hands over the
//                                      live Vercel URL for the whole Data
//                                      Room; that line is the originating
//                                      example, the same way reframe_question
//                                      cites onboard and instant_brief cites
//                                      new-project). It is a REWARD, not an
//                                      opt-out: the eight prior members could
//                                      each only describe publish falsely, and
//                                      `--none (diagnostic surface)` would be
//                                      false in the opposite direction, since
//                                      publish performs an irreversible action
//                                      and hands back an artifact rather than
//                                      reporting state.
