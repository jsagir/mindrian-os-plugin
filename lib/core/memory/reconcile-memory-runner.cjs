...
module.exports = {
  ...
  extractBrainAnchors,
  deriveFreshness,
  // Phase 195-03 FCM-04: the born-wired birth seeder derives child USER/BRAIN
  // from the parent using ONLY these generic-handle extractors (Part 8: generic
  // persona enums + frozen framework handles cross the cord; never user prose).
  extractPersona,
};
