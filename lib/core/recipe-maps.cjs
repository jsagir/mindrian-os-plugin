...
function _loadManifest() {
  ...
  try {
    ...
    _manifestCache = {
      ...
      // Phase 298 (SEED-032, R-10): a tolerant read of the policies digest
      // block. The three read-joins below ignore it entirely.
    ...
    _manifestCache = { methodology_tier: null, version: null, maps: [], runtime_surfaces: [], policies: null };
  }
