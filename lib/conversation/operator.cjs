...
// The 7 transition rules from CONTEXT.md D-08. Encoded as a list of
// { from, to, allowed_triggers } records. 'ANY' as `from` means any current
// operator is permitted as the source.
